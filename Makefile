...
background:
	...
	@ docker-compose -f $(DOCKER_DEV_COMPOSE_FILE) build dashboard
...
test:background
	...
	@ docker-compose -f $(DOCKER_DEV_COMPOSE_FILE) exec dashboard yarn test
...
ssh:background
	...
	@ docker-compose -f $(DOCKER_DEV_COMPOSE_FILE) exec dashboard bash
